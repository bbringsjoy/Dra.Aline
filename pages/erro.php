<div class="container">
    ...
    <img src="imagens/sad_teeth2-removebg-preview.png" alt="Erro" class="text-center w-100">
    ...
    <div class="col-md-12 text-center user-select-none">
        ...
        <p>Por favor, verifique o endereço ou volte para a <a href="home"><i class="fa-solid fa-house"></i>
        Página inicial</a>.</p>
