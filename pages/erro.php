...
<div class="container">
    ...
    <div class="erro col-md-12 text-center user-select-none">
    ...
    <img src="imagens/sad_teeth2-removebg-preview.png" alt="Erro" class="img-center w-100">
        ...
        <p>Por favor, verifique o endereço ou volte para a </p>
            <p> <a class="botao zoom-hover fs-4" href="home"><i class="fa-solid fa-house"></i>
        Página inicial</a>. </p>
